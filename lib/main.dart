...
class _HomePageState extends State<HomePage>
  ...
  int pendingCount = 5; // or tasks.length if you want dynamic
  int finishedCount = 0;
          ...
          onDismissed: (direction) {
            setState(() {
              ...
              if (direction == DismissDirection.startToEnd) {
                tasks.add(task); // re-add to pending
              } else {
                finishedCount++;
                pendingCount--;
              }
...
class _StarryBackgroundState extends State<StarryBackground>
  ...
  Widget build(BuildContext context) {
    return Container(
      color: const Color.fromARGB(255, 7, 1, 36), // 🌌 Background color
